...
import { createClient as createClient$1, defaultExchanges, subscriptionExchange } from '@urql/core';
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch(url, _extends({}, this.options, {
                method: 'GET'
              }));
...
var SubscriptionConnector = function SubscriptionConnector(params) {
  ...
  this.subscribeToProductUpdate = function (observable, nacelleEntryIds) {
    ...
    try {
      var _pipe = pipe(_this.wsClient.subscription(productSubscription, {
  ...
  this.subscribeToProductVariantUpdate = function (observable, nacelleEntryIds) {
    ...
    try {
      var _pipe2 = pipe(_this.wsClient.subscription(productVariantSubscription, {
  ...
  this.wsClient = params.wsClient || createClient$1({
    url: this.endpoint,
    exchanges: [].concat(defaultExchanges, [subscriptionExchange({
...
export { DataSourceName, EntryType, Locales, Storefront, Storefront as default };
//# sourceMappingURL=storefront-sdk.esm.js.map
