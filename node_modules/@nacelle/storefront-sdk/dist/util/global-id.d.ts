...
export declare const gidPrefix = "gid://";
export declare const encodedGidPrefix = "Z2lkOi8v";
/**
 * @description Base64 encoded string starting with 'gid://'
 */
export declare type GlobalId = string;
/**
 ...
 */
export declare type EntryId = GlobalId;
 ...
 */
export declare function constructEntryId(id: string | number, source: DataSourceName, sourceUniqueId: string, type: string, subset: string): EntryId;
/**
 * @example
 * const {
    decodedGid,
 ...
 */
export declare function deconstructEntryId(gid: EntryId): EntryIdParts;
/**
 * @example
 ...
 * @return returns a global id
 */
export declare function convertEntryId(id: string | number, source: DataSourceName, sourceUniqueId: string, type: EntryType, subset: string): EntryId;
/**
 ...
 */
export declare function isEntryId(id: string | number): boolean;
